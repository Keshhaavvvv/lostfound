...
/*
    File: report.php
    Purpose: Report an item (Dark Theme + Location + Category).
*/
include 'db.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 2. Updated Insert Query (Included 'location' and 'category')
    $sql = "INSERT INTO items (user_id, title, description, location, category, date_incident, type, image_path, is_sensitive, status) 
            VALUES ('$user_id', '$title', '$description', '$location', '$category', '$date_incident', '$type', '$image_path', '$is_sensitive', 'active')";
...
<head>
    ...
    <style>
        ...
        /* Dark Inputs (Applied to select as well) */
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select name="location" required>
                <option value="Campus General">Campus General</option>
